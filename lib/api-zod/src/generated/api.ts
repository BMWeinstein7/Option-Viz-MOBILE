...
export const GetChainSummaryResponse = zod.object({
  ...
  "totalCallOpenInterest": zod.int(),
  "totalPutOpenInterest": zod.int(),
  "totalCallVolume": zod.int(),
  "totalPutVolume": zod.int(),
  "strikes": zod.array(zod.object({
  "strike": zod.number(),
  "callOpenInterest": zod.int(),
  "putOpenInterest": zod.int(),
  "callVolume": zod.int(),
  "putVolume": zod.int(),
  "callIV": zod.number(),
  "putIV": zod.number(),
...
export const GetPriceHistoryQueryParams = zod.object({
  "range": zod.enum(['1mo', '3mo', '6mo', '1y']).default(getPriceHistoryQueryRangeDefault)
})
...
export const AnalyzeStrategyResponse = zod.object({
  "pnlAtExpiry": zod.array(zod.object({
  "price": zod.number(),
  "pnl": zod.number()
})),
  "greeks": zod.object({
